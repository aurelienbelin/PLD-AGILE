...
public class VueGraphique extends HBox implements Observer {
    ...
    public void calculEchelle (List <modele.outils.Intersection> intersections) {
        ...
        double echelleLatitude = (abs(maxLatitude-minLatitude)) / this.getHeight(); //hauteur fenetre
        double echelleLongitude = (abs(maxLongitude-minLongitude)) / this.getWidth(); //longueur fenetre
